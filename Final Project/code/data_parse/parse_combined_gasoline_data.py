...
raw_data_path = 'data/raw/combined_gasoline_data.csv'
export_path = 'data/clean/clean_combined_gasoline_data.csv'
...
# Rename 'Data Name' to 'Date'
df = df.rename(columns={'Data Name': 'Date'})

# Convert 'Date' column to datetime format
df['Date'] = pd.to_datetime(df['Date'], format='%d-%b-%y')

# Drop columns with fewer than 1200 non-null values
