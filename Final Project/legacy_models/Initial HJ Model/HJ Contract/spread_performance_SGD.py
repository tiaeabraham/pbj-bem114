...
from spread_model_SGD import SpreadModel  # Import your model
...
def evaluate_spread_model(df, max_iter, tol, random_state, backtest_period, bet_size):
    """
    ...
    Args:
        ...
        tol (float): The tolerance for convergence of the model.
    ...
    model = SpreadModel(max_iter=max_iter, tol=tol,
                        random_state=random_state, backtest_period=backtest_period)

    # Train the model and obtain test set and corresponding dates
